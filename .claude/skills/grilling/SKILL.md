---
name: grilling
description: Relentless one-question-at-a-time requirement interviews. Use when an idea, requirement, or design needs to be sharpened with the user before it is written down — during /pollinate PRD interviews, /sting sessions, or whenever fuzzy intent must become precise, agreed language.
---
...
> The templates in docs/templates/ already carry frontmatter schemas, so I'll
> assume new PRDs follow docs/templates/prd.md — correct?
